...
public class ModelAquaDraco extends ModelBase
{
  ...
  public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity)
  {
	...
	this.frontRightLeg.rotateAngleX = MathHelper.cos(f * 0.8662F) * 1F * f1;
	this.backRightLeg.rotateAngleX = MathHelper.cos(f * 0.8662F) * 1F * f1;
	this.frontLeftLeg.rotateAngleX = MathHelper.cos(f * 0.8662F + (float)Math.PI) * 1F * f1;
	this.backLeftLeg.rotateAngleX = MathHelper.cos(f * 0.8662F + (float)Math.PI) * 1F * f1;
